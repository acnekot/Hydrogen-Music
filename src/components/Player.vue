...
const pluginControlButtons = usePluginArea('ui:player-controls');
const resolvedPluginButtons = computed(() => {
    return pluginControlButtons.value
        .map((entry, index) => ({
            ...entry,
            key: entry.id || `${entry.__plugin?.id || 'plugin'}-${index}`,
    ...
    <div class="player-container">
        <div class="player">
            ...
            <div class="song-control">
                ...
                <component
                    v-for="control in resolvedPluginButtons"
