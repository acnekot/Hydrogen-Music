...
import { usePluginManager } from '@/plugins/core/usePluginManager';
...
const lyricVisualizerExtensions = pluginManager.useSlot('lyric.visualizer');
...
const visualizerSlotProps = computed(() => ({
    lyricAreaVisible: lyricAreaVisible.value,
    lyricPlaceholderVisible: lyricPlaceholderVisible.value,
    lyricScrollRef: lyricScroll,
    lyricContainerRef: lyricContainer,
}));
...
<template>
    <div class="lyric-container" :class="lyricContainerClasses" :style="lyricBackgroundStyle" ref="lyricContainer">
        <component
            v-for="extension in lyricVisualizerExtensions"
            :key="extension.id"
            :is="extension.component"
            :slot-props="visualizerSlotProps"
