...
const applyCustomBackgroundToPlayer = computed(
    () => customBackgroundActive.value && playerStore.customBackgroundApplyToPlayer
);
</script>

<template>
    <div class="music-player" :class="{ 'music-player--custom': applyCustomBackgroundToPlayer }">
        <Player
