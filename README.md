...
- 迁移至 **Quasar Framework**，提供统一的桌面端 UI 体验与主题定制能力
- 支持了多系统版本的安装包
...
- 项目已全面采用 [Quasar Framework](https://quasar.dev/) 作为 Vue 3 UI 层，配合 Electron 构建桌面端体验。
- 默认启用的主题变量位于 `src/assets/quasar-variables.sass`，可根据品牌色或自定义主题进行调整。
